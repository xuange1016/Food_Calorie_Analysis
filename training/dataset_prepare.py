"""
整理 Food-101 数据集，筛选课程设计第一版需要的 10 类食物。
...
2. 只筛选 training/selected_classes.json 中配置的类别；
...
def main() -> None:
    ...
    selected_classes = load_selected_classes(args.classes)
    ...
    save_class_names(sorted(selected_classes), DEFAULT_CLASS_NAMES_PATH)
    ...
    print()
    print("数据集整理完成。")
    print(f"类别顺序已保存: {DEFAULT_CLASS_NAMES_PATH}")
